...
return array(
    ...
    'properties' => [
        'creator'        => 'Log My Games!',
        'lastModifiedBy' => 'Log My Games!',
        'title'          => 'Log My Games! - Game Export',
        'description'    => 'Log My Games! - Game Export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'excel, export',
        'category'       => 'Excel',
        'manager'        => 'Log My Games!',
        'company'        => 'Log My Games!',
    ],
